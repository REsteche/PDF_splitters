...
file2pages = {
    0: [0, 100], # 1st splitted PDF file will contain the pages from 0 to 9 (9 is not included)
    1: [100, 200], # 2nd splitted PDF file will contain the pages from 9 (9 is included) to 11
    2: [200, 300], # 3rd splitted PDF file will contain the pages from 11 until the end or until the 100th page (if exists)
}
